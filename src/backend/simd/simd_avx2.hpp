...
namespace helix::simd {
    ...
    inline void store(float* ptr, const __m256 vec) { _mm256_storeu_ps(ptr, vec); }
    ...
    inline __m256 broadcast(const float val) { return _mm256_set1_ps(val); }
